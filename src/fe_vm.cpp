...
bool FeVM::on_new_layout()
{
	...
	fe.Bind( _SC("Presentable"),
		...
		Class<FeBasePresentable, NoConstructor<FeBasePresentable>>(Sqrat::DefaultVM::Get(), _SC("Presentable"), true)
		.Prop(_SC("visible"),
	...
	fe.Bind( _SC("LayoutGlobals"), Class <FePresent, NoConstructor<FePresent>>(Sqrat::DefaultVM::Get(), _SC("LayoutGlobals"), true)
	...
	fe.Bind( _SC("CurrentList"), Class <FePresent, NoConstructor<FePresent>>(Sqrat::DefaultVM::Get(), _SC("CurrentList"), true)
	...
	fe.Bind( _SC("Overlay"), Class <FeVM, NoConstructor<FeVM>>(Sqrat::DefaultVM::Get(), _SC("Overlay"), true)
...
//		.Func( _SC("set_custom_controls"), &FeVM::overlay_set_custom_controls)
	...
	fe.Bind( _SC("Sound"), Class <FeSound, NoConstructor<FeSound>>(Sqrat::DefaultVM::Get(), _SC("Sound"), true)
	...
	fe.Bind( _SC("Shader"), Class <FeShader, NoConstructor<FeShader>>(Sqrat::DefaultVM::Get(), _SC("Shader"), true)
	...
	fe.Bind( _SC("Display"), Class <FeDisplayInfo, NoConstructor<FeDisplayInfo>>(Sqrat::DefaultVM::Get(), _SC("Display"), true)
	...
	fe.Bind( _SC("Filter"), Class <FeFilter, NoConstructor<FeFilter>>(Sqrat::DefaultVM::Get(), _SC("Filter"), true)
	...
	fe.Bind( _SC("PresentableParent"), Class <FePresentableParent, NoConstructor<FePresentableParent>>(Sqrat::DefaultVM::Get(), _SC("PresentableParent"), true)
...
public:
		...
		bool limited=false )
	{
		...
		if ( !limited )
		{
			...
			//
			fe.Bind( _SC("Overlay"), Sqrat::Class <FeVM, Sqrat::NoConstructor<FeVM>>(Sqrat::DefaultVM::Get(), _SC("Overlay"), true)
				.Prop( _SC("is_up"), &FeVM::overlay_is_on )
				.Overload<bool (FeVM::*)(const char *, const char *)>( _SC("splash_message"), &FeVM::splash_message )
				.Overload<bool (FeVM::*)(const char *)>( _SC("splash_message"), &FeVM::splash_message )
			);
			...
			fe.Bind( _SC("Display"), Sqrat::Class <FeDisplayInfo, Sqrat::NoConstructor<FeDisplayInfo>>(Sqrat::DefaultVM::Get(), _SC("Display"), true)
				.Prop( _SC("name"), &FeDisplayInfo::get_name )
				.Prop( _SC("layout"), &FeDisplayInfo::get_layout )
				.Prop( _SC("romlist"), &FeDisplayInfo::get_romlist_name )
				.Prop( _SC("in_cycle"), &FeDisplayInfo::show_in_cycle )
			...
			fe.Bind( _SC("Filter"), Sqrat::Class <FeFilter, Sqrat::NoConstructor<FeFilter>>(Sqrat::DefaultVM::Get(), _SC("Filter"), true)
				.Prop( _SC("name"), &FeFilter::get_name )
				.Prop( _SC("index"), &FeFilter::get_rom_index )
				.Prop( _SC("size"), &FeFilter::get_size )
				.Prop( _SC("sort_by"), &FeFilter::get_sort_by )
			...
			fe.Bind( _SC("Monitor"), Sqrat::Class <FeMonitor, Sqrat::NoConstructor<FeMonitor>>(Sqrat::DefaultVM::Get(), _SC("Monitor"), true)
				.Prop( _SC("num"), &FeMonitor::get_num )
				.Prop( _SC("width"), &FeMonitor::get_width )
				.Prop( _SC("height"), &FeMonitor::get_height )
			);
